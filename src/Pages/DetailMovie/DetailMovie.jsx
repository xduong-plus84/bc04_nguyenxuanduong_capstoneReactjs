      ...
      <div className="container w-2/3 mx-auto  mt-20 min-h-fit">
        <div className="flex mb-20">
          ...
          <div className="ml-10 text-left flex flex-col items-start justify-center">
            ...
            <button className="mt-4 mr-2 mb-2 py-2 px-8 font-semibold border rounded-xl text-white bg-red-700 hover:bg-red-500 transition duration-300">
              Đặt vé
            </button>
          </div>
        </div>
        <Tabs centered items={items} style={{ height: 700 }} />
      </div>
    </div>
  );
}
